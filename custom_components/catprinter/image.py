"""Image platform -- shows the last image printed or previewed."""
...
async def async_setup_entry(
    ...
    """Set up the CatPrinter image entity."""
...
class CatPrinterImageEntity(
    ...
    def available(self) -> bool:
        """Always available -- it holds either an image or the empty placeholder."""
        return True
    ...
    def _handle_coordinator_update(self) -> None:
        _LOGGER.debug("Updated print image")
